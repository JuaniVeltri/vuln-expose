...
export const metadata: Metadata = {
  ...
  description:
    "Learn and practice SQL injection authentication bypass techniques. Educational platform for testing login vulnerabilities and pentesting authentication systems.",
  keywords:
    "SQL injection login, authentication bypass, SQL injection tutorial, login vulnerability, pentesting authentication",
  openGraph: {
    title: "SQL Injection Authentication Bypass - VulnSite",
    description:
      "Practice SQL injection techniques for bypassing authentication systems",
  },
};
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Explota vulnerabilidades de autenticación mediante técnicas
              avanzadas de SQL injection
            </p>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-700/50 rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm font-mono text-gray-300">
                      <p className="bg-gray-800/70 p-2 rounded">
                        admin&apos; --
                      </p>
                      <p className="bg-gray-800/70 p-2 rounded">
                        &apos; OR &apos;1&apos;=&apos;1&apos; --
